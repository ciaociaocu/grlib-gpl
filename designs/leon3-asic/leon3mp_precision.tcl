...
add_input_file -format VHDL -work work spw_lvttl_pads.vhd
add_input_file -format VHDL -work work bschain.vhd
add_input_file -format VHDL -work work core_clock_mux.vhd
add_input_file -format VHDL -work work leon3core.vhd
add_input_file -format VHDL -work work core.vhd
add_input_file -format VHDL -work work pads.vhd
