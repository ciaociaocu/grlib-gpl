...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-6250-coding/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      rt::read_verilog {
      ./.Xil/Vivado-6250-coding/realtime/mig_stub.v
      ./.Xil/Vivado-6250-coding/realtime/mig_cdc_stub.v
    }
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-6250-coding/"
