new_project -name leon5mp -folder . -createimpl_name precision
...
add_input_file -format VHDL -work grlib grlib_config_leon5.vhd
...
add_input_file -format VHDL -work work rtl/ahb2axi_mig4_7series.vhd
add_input_file -format VHDL -work work rtl/sgmii_kcu105.vhd
add_input_file -format VHDL -work work config.vhd
add_input_file -format VHDL -work work ahbrom128.vhd
