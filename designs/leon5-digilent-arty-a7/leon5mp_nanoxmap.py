...
project.setVariantName('XC7A100TIcsg324-1L')
project.setTopCellName('work', 'leon5mp')
...
project.addFile('grlib','grlib_config_leon5.vhd')
...
# Read pin map
if os.path.exists(os.path.join(workdir, 'leon5mp_pads.py')):
    from leon5mp_pads import pads
    project.addPads(pads)
# Generate Project file
project.save('leon5mp_native.nym')
