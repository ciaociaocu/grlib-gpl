...
create_project leon5-digilent-arty-a7 ./vivado/leon5-digilent-arty-a7 -part XC7A100TIcsg324-1L -force
...
read_vhdl -library grlib grlib_config_leon5.vhd
...
set_property top leon5mp [current_fileset]
set_property target_language verilog [current_project]
#upgrade_ip [get_ips mig]
generate_target  all [get_files ./vivado/leon5-digilent-arty-a7/leon5-digilent-arty-a7.srcs/sources_1/ip/mig/mig.xci] -force 
